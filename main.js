...
var ContactComponent = /** @class */ (function () {
    ...
    ContactComponent.prototype.submitForm = function () {
        var message = "My name is " + this.name + ". My email is " + this.email + ". My message is " + this.message;
        alert(message);
    };
...
module.exports = __webpack_require__(/*! /Users/morlov/WebstormProjects/Kiriko/angular-test-site/src/main.ts */"./src/main.ts");
